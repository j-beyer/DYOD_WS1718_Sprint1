...
namespace opossum {
    ...
    template <typename T>
    std::shared_ptr<const Table> TableScan::TableScanImpl<T>::on_execute(const AllTypeVariant & search_value_variant, const std::shared_ptr<const Table> table, const ColumnID column_id) {
